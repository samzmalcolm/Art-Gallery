...
<br>
            ...
            <div class="side_menu_bottom">
                <div class="side_menu_bottom_inner">
                    ...
                    <div class="copy_right">
                        <p class="copyright">Copyright &copy;All rights reserved | <a href="homePage.jsp">Art House</a> </p>
                    </div>
                </div>
            </div>
        ...
        <!--=================== content body ====================-->
        <div class="col-lg-10 col-md-9 col-12 body_block  align-content-center" style="background-color: #333333;">
	    ...
	    <ul class="ch-grid">
	        ...
	        <li>
	            ...
	            <div class="ch-item" style="background-image: url(inst1.png);  background-repeat: no-repeat;background-size: 250px; ">

	            <div class="ch-info">

	            <h3>Use what you have</h3>

	            by Mehul <a href="#">View on TryCatch</a>
	        ...
	        <li>
	            ...
	            <div class="ch-item "style="background-image: url(inst4.png);  background-repeat: no-repeat;background-size: 250px;">

	            <div class="ch-info">

	            <h3>Common Causes of Stains</h3>

	            by Mohnish <a href="#">View on TryCatch</a>
	       ...
	       <li>
            ...
            <br>
        <div>
                <h1 style="color: white; font-style: Brush Script MT, Brush Script Std, cursive; ">Top Arts</h1>
            </div> 
